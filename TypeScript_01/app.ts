(() => {
    ...
    // Liskov substitution principle (LSP): This principle states that we should be able to replace a class in a program 
    ...
    class Duck1 extends FlyingBird {}

    class Straus1 extends Bird1 {}
    ...
    // Dependency inversion principle (DIP): This principle states that entities should depend on abstractions (interfaces) as 
    ...
    class Alert1 implements IAlert {
        send(): void {
            console.log('Notification sent')
        }
    }
